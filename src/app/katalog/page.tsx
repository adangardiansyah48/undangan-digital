...
function seedFallback(active: string): SeedItem[] {
  const all: SeedItem[] = [
    ...
    { slug: "opaline", category: "wedding", title: "Opaline", description: "Pearl serif soft", is_premium: true, is_new: true, thumbnail_url: null },
    { slug: "velours-nuit", category: "wedding", title: "Velours Nuit", description: "Midnight velvet", is_premium: true, is_new: true, thumbnail_url: null },
    { slug: "atelier-blush", category: "wedding", title: "Atelier Blush", description: "Studio blush line", is_premium: true, thumbnail_url: null },
    { slug: "maison-lace", category: "wedding", title: "Maison Lace", description: "Lace ivory fine", is_premium: false, thumbnail_url: null },
    { slug: "jardin-noir", category: "wedding", title: "Jardin Noir", description: "Dark garden rose", is_premium: true, thumbnail_url: null },
    { slug: "aureline", category: "wedding", title: "Aurèline", description: "Gold aureline", is_premium: true, thumbnail_url: null },
    { slug: "brume", category: "wedding", title: "Brume", description: "Mist veil elegant", is_premium: false, thumbnail_url: null },
    { slug: "chantelle", category: "wedding", title: "Chantelle", description: "Chantilly script", is_premium: true, thumbnail_url: null },
    { slug: "seraphine", category: "wedding", title: "Séraphine", description: "Angel silk", is_premium: false, thumbnail_url: null },
    { slug: "divine-ivory", category: "wedding", title: "Divine Ivory", description: "Divine column", is_premium: true, thumbnail_url: null },
